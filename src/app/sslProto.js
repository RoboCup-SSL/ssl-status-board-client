...
$root.BotId = (function () {
  ...
  BotId.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader))
      reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.BotId();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
$root.ControllerReply = (function () {
  ...
  ControllerReply.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader))
      reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ControllerReply();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  ControllerReply.fromObject = function fromObject(object) {
    if (object instanceof $root.ControllerReply)
      return object;
    var message = new $root.ControllerReply();
...
$root.BallSpeedMeasurement = (function () {
  ...
  BallSpeedMeasurement.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader))
      reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.BallSpeedMeasurement();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  BallSpeedMeasurement.fromObject = function fromObject(object) {
    if (object instanceof $root.BallSpeedMeasurement)
      return object;
    var message = new $root.BallSpeedMeasurement();
...
$root.GameEvent = (function () {
  ...
  GameEvent.verify = function verify(message) {
    ...
    if (message.prepared != null && message.hasOwnProperty("prepared")) {
      properties.event = 1;
      {
        var error = $root.GameEvent.Prepared.verify(message.prepared);
        if (error)
    ...
    if (message.noProgressInGame != null && message.hasOwnProperty("noProgressInGame")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.NoProgressInGame.verify(message.noProgressInGame);
        if (error)
    ...
    if (message.placementFailed != null && message.hasOwnProperty("placementFailed")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.PlacementFailed.verify(message.placementFailed);
        if (error)
    ...
    if (message.placementSucceeded != null && message.hasOwnProperty("placementSucceeded")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.PlacementSucceeded.verify(message.placementSucceeded);
        if (error)
    ...
    if (message.botSubstitution != null && message.hasOwnProperty("botSubstitution")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotSubstitution.verify(message.botSubstitution);
        if (error)
    ...
    if (message.tooManyRobots != null && message.hasOwnProperty("tooManyRobots")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.TooManyRobots.verify(message.tooManyRobots);
        if (error)
    ...
    if (message.ballLeftFieldTouchLine != null && message.hasOwnProperty("ballLeftFieldTouchLine")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BallLeftField.verify(message.ballLeftFieldTouchLine);
        if (error)
    ...
    if (message.ballLeftFieldGoalLine != null && message.hasOwnProperty("ballLeftFieldGoalLine")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BallLeftField.verify(message.ballLeftFieldGoalLine);
        if (error)
    ...
    if (message.possibleGoal != null && message.hasOwnProperty("possibleGoal")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.Goal.verify(message.possibleGoal);
        if (error)
    ...
    if (message.goal != null && message.hasOwnProperty("goal")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.Goal.verify(message.goal);
        if (error)
          return "goal." + error;
      }
    }
    if (message.indirectGoal != null && message.hasOwnProperty("indirectGoal")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.IndirectGoal.verify(message.indirectGoal);
        if (error)
    ...
    if (message.chippedGoal != null && message.hasOwnProperty("chippedGoal")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.ChippedGoal.verify(message.chippedGoal);
        if (error)
    ...
    if (message.aimlessKick != null && message.hasOwnProperty("aimlessKick")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.AimlessKick.verify(message.aimlessKick);
        if (error)
    ...
    if (message.kickTimeout != null && message.hasOwnProperty("kickTimeout")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.KickTimeout.verify(message.kickTimeout);
        if (error)
    ...
    if (message.keeperHeldBall != null && message.hasOwnProperty("keeperHeldBall")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.KeeperHeldBall.verify(message.keeperHeldBall);
        if (error)
    ...
    if (message.attackerDoubleTouchedBall != null && message.hasOwnProperty("attackerDoubleTouchedBall")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.AttackerDoubleTouchedBall.verify(message.attackerDoubleTouchedBall);
        if (error)
    ...
    if (message.attackerInDefenseArea != null && message.hasOwnProperty("attackerInDefenseArea")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.AttackerInDefenseArea.verify(message.attackerInDefenseArea);
        if (error)
    ...
    if (message.attackerTouchedKeeper != null && message.hasOwnProperty("attackerTouchedKeeper")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.AttackerTouchedKeeper.verify(message.attackerTouchedKeeper);
        if (error)
    ...
    if (message.botDribbledBallTooFar != null && message.hasOwnProperty("botDribbledBallTooFar")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotDribbledBallTooFar.verify(message.botDribbledBallTooFar);
        if (error)
    ...
    if (message.botKickedBallTooFast != null && message.hasOwnProperty("botKickedBallTooFast")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotKickedBallTooFast.verify(message.botKickedBallTooFast);
        if (error)
    ...
    if (message.attackerTooCloseToDefenseArea != null && message.hasOwnProperty("attackerTooCloseToDefenseArea")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.AttackerTooCloseToDefenseArea.verify(message.attackerTooCloseToDefenseArea);
        if (error)
    ...
    if (message.botInterferedPlacement != null && message.hasOwnProperty("botInterferedPlacement")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotInterferedPlacement.verify(message.botInterferedPlacement);
        if (error)
    ...
    if (message.botCrashDrawn != null && message.hasOwnProperty("botCrashDrawn")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotCrashDrawn.verify(message.botCrashDrawn);
        if (error)
    ...
    if (message.botCrashUnique != null && message.hasOwnProperty("botCrashUnique")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotCrashUnique.verify(message.botCrashUnique);
        if (error)
    ...
    if (message.botCrashUniqueSkipped != null && message.hasOwnProperty("botCrashUniqueSkipped")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotCrashUnique.verify(message.botCrashUniqueSkipped);
        if (error)
    ...
    if (message.botPushedBot != null && message.hasOwnProperty("botPushedBot")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotPushedBot.verify(message.botPushedBot);
        if (error)
    ...
    if (message.botPushedBotSkipped != null && message.hasOwnProperty("botPushedBotSkipped")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotPushedBot.verify(message.botPushedBotSkipped);
        if (error)
    ...
    if (message.botHeldBallDeliberately != null && message.hasOwnProperty("botHeldBallDeliberately")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotHeldBallDeliberately.verify(message.botHeldBallDeliberately);
        if (error)
    ...
    if (message.botTippedOver != null && message.hasOwnProperty("botTippedOver")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotTippedOver.verify(message.botTippedOver);
        if (error)
    ...
    if (message.botTooFastInStop != null && message.hasOwnProperty("botTooFastInStop")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.BotTooFastInStop.verify(message.botTooFastInStop);
        if (error)
    ...
    if (message.defenderTooCloseToKickPoint != null && message.hasOwnProperty("defenderTooCloseToKickPoint")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.DefenderTooCloseToKickPoint.verify(message.defenderTooCloseToKickPoint);
        if (error)
    ...
    if (message.defenderInDefenseAreaPartially != null && message.hasOwnProperty("defenderInDefenseAreaPartially")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.DefenderInDefenseAreaPartially.verify(message.defenderInDefenseAreaPartially);
        if (error)
    ...
    if (message.defenderInDefenseArea != null && message.hasOwnProperty("defenderInDefenseArea")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.DefenderInDefenseArea.verify(message.defenderInDefenseArea);
        if (error)
    ...
    if (message.multipleCards != null && message.hasOwnProperty("multipleCards")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.MultipleCards.verify(message.multipleCards);
        if (error)
    ...
    if (message.multiplePlacementFailures != null && message.hasOwnProperty("multiplePlacementFailures")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.MultiplePlacementFailures.verify(message.multiplePlacementFailures);
        if (error)
    ...
    if (message.multipleFouls != null && message.hasOwnProperty("multipleFouls")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.MultipleFouls.verify(message.multipleFouls);
        if (error)
    ...
    if (message.unsportingBehaviorMinor != null && message.hasOwnProperty("unsportingBehaviorMinor")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.UnsportingBehaviorMinor.verify(message.unsportingBehaviorMinor);
        if (error)
    ...
    if (message.unsportingBehaviorMajor != null && message.hasOwnProperty("unsportingBehaviorMajor")) {
      ...
      properties.event = 1;
      {
        var error = $root.GameEvent.UnsportingBehaviorMajor.verify(message.unsportingBehaviorMajor);
        if (error)
  ...
  GameEvent.fromObject = function fromObject(object) {
    ...
    if (object.origin) {
      ...
      message.origin = [];
      for (var i = 0; i < object.origin.length; ++i)
  ...
  GameEvent.toObject = function toObject(message, options) {
    ...
    if (message.origin && message.origin.length) {
      object.origin = [];
      for (var j = 0; j < message.origin.length; ++j)
  ...
  GameEvent.BallLeftField = (function () {
    ...
    BallLeftField.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.BallLeftField();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BallLeftField.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BallLeftField)
        return object;
      var message = new $root.GameEvent.BallLeftField();
  ...
  GameEvent.AimlessKick = (function () {
    ...
    AimlessKick.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.AimlessKick();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    AimlessKick.verify = function verify(message) {
      ...
      if (message.kickLocation != null && message.hasOwnProperty("kickLocation")) {
        var error = $root.Location.verify(message.kickLocation);
        if (error)
    ...
    AimlessKick.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.AimlessKick)
        return object;
      var message = new $root.GameEvent.AimlessKick();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.Goal = (function () {
    ...
    Goal.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.Goal();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    Goal.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.Goal)
        return object;
      var message = new $root.GameEvent.Goal();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.IndirectGoal = (function () {
    ...
    IndirectGoal.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.IndirectGoal();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    IndirectGoal.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.IndirectGoal)
        return object;
      var message = new $root.GameEvent.IndirectGoal();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.ChippedGoal = (function () {
    ...
    ChippedGoal.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.ChippedGoal();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    ChippedGoal.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.ChippedGoal)
        return object;
      var message = new $root.GameEvent.ChippedGoal();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotTooFastInStop = (function () {
    ...
    BotTooFastInStop.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.BotTooFastInStop();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotTooFastInStop.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotTooFastInStop)
        return object;
      var message = new $root.GameEvent.BotTooFastInStop();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.DefenderTooCloseToKickPoint = (function () {
    ...
    DefenderTooCloseToKickPoint.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.DefenderTooCloseToKickPoint();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    DefenderTooCloseToKickPoint.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.DefenderTooCloseToKickPoint)
        return object;
      var message = new $root.GameEvent.DefenderTooCloseToKickPoint();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotCrashDrawn = (function () {
    ...
    BotCrashDrawn.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.BotCrashDrawn();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotCrashDrawn.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotCrashDrawn)
        return object;
      var message = new $root.GameEvent.BotCrashDrawn();
  ...
  GameEvent.BotCrashUnique = (function () {
    ...
    BotCrashUnique.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.BotCrashUnique();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotCrashUnique.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotCrashUnique)
        return object;
      var message = new $root.GameEvent.BotCrashUnique();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotPushedBot = (function () {
    ...
    BotPushedBot.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.BotPushedBot();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotPushedBot.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotPushedBot)
        return object;
      var message = new $root.GameEvent.BotPushedBot();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotTippedOver = (function () {
    ...
    BotTippedOver.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.BotTippedOver();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotTippedOver.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotTippedOver)
        return object;
      var message = new $root.GameEvent.BotTippedOver();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.DefenderInDefenseArea = (function () {
    ...
    DefenderInDefenseArea.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.DefenderInDefenseArea();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    DefenderInDefenseArea.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.DefenderInDefenseArea)
        return object;
      var message = new $root.GameEvent.DefenderInDefenseArea();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.DefenderInDefenseAreaPartially = (function () {
    ...
    DefenderInDefenseAreaPartially.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.DefenderInDefenseAreaPartially();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    DefenderInDefenseAreaPartially.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.DefenderInDefenseAreaPartially)
        return object;
      var message = new $root.GameEvent.DefenderInDefenseAreaPartially();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.AttackerInDefenseArea = (function () {
    ...
    AttackerInDefenseArea.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.AttackerInDefenseArea();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    AttackerInDefenseArea.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.AttackerInDefenseArea)
        return object;
      var message = new $root.GameEvent.AttackerInDefenseArea();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotKickedBallTooFast = (function () {
    ...
    BotKickedBallTooFast.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.BotKickedBallTooFast();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotKickedBallTooFast.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotKickedBallTooFast)
        return object;
      var message = new $root.GameEvent.BotKickedBallTooFast();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotDribbledBallTooFar = (function () {
    ...
    BotDribbledBallTooFar.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.BotDribbledBallTooFar();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotDribbledBallTooFar.verify = function verify(message) {
      ...
      if (message.byBot != null && message.hasOwnProperty("byBot"))
        if (!$util.isInteger(message.byBot))
          return "byBot: integer expected";
      if (message.start != null && message.hasOwnProperty("start")) {
        var error = $root.Location.verify(message.start);
        if (error)
          return "start." + error;
      }
      if (message.end != null && message.hasOwnProperty("end")) {
        var error = $root.Location.verify(message.end);
        if (error)
          return "end." + error;
      }
      return null;
    ...
    BotDribbledBallTooFar.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotDribbledBallTooFar)
        return object;
      var message = new $root.GameEvent.BotDribbledBallTooFar();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.AttackerTouchedKeeper = (function () {
    ...
    AttackerTouchedKeeper.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.AttackerTouchedKeeper();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    AttackerTouchedKeeper.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.AttackerTouchedKeeper)
        return object;
      var message = new $root.GameEvent.AttackerTouchedKeeper();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.AttackerDoubleTouchedBall = (function () {
    ...
    AttackerDoubleTouchedBall.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.AttackerDoubleTouchedBall();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    AttackerDoubleTouchedBall.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.AttackerDoubleTouchedBall)
        return object;
      var message = new $root.GameEvent.AttackerDoubleTouchedBall();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.AttackerTooCloseToDefenseArea = (function () {
    ...
    AttackerTooCloseToDefenseArea.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.AttackerTooCloseToDefenseArea();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    AttackerTooCloseToDefenseArea.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.AttackerTooCloseToDefenseArea)
        return object;
      var message = new $root.GameEvent.AttackerTooCloseToDefenseArea();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotHeldBallDeliberately = (function () {
    ...
    BotHeldBallDeliberately.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.BotHeldBallDeliberately();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotHeldBallDeliberately.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotHeldBallDeliberately)
        return object;
      var message = new $root.GameEvent.BotHeldBallDeliberately();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.BotInterferedPlacement = (function () {
    ...
    BotInterferedPlacement.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.BotInterferedPlacement();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotInterferedPlacement.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotInterferedPlacement)
        return object;
      var message = new $root.GameEvent.BotInterferedPlacement();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.MultipleCards = (function () {
    ...
    MultipleCards.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.MultipleCards();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    MultipleCards.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.MultipleCards)
        return object;
      var message = new $root.GameEvent.MultipleCards();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.MultipleFouls = (function () {
    ...
    MultipleFouls.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.MultipleFouls();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    MultipleFouls.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.MultipleFouls)
        return object;
      var message = new $root.GameEvent.MultipleFouls();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.MultiplePlacementFailures = (function () {
    ...
    MultiplePlacementFailures.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.MultiplePlacementFailures();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    MultiplePlacementFailures.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.MultiplePlacementFailures)
        return object;
      var message = new $root.GameEvent.MultiplePlacementFailures();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.KickTimeout = (function () {
    ...
    KickTimeout.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.KickTimeout();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    KickTimeout.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.KickTimeout)
        return object;
      var message = new $root.GameEvent.KickTimeout();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.NoProgressInGame = (function () {
    ...
    NoProgressInGame.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.NoProgressInGame();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    NoProgressInGame.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.NoProgressInGame)
        return object;
      var message = new $root.GameEvent.NoProgressInGame();
      if (object.location != null) {
        if (typeof object.location !== "object")
  ...
  GameEvent.PlacementFailed = (function () {
    ...
    PlacementFailed.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.PlacementFailed();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    PlacementFailed.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.PlacementFailed)
        return object;
      var message = new $root.GameEvent.PlacementFailed();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.UnsportingBehaviorMinor = (function () {
    ...
    UnsportingBehaviorMinor.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.UnsportingBehaviorMinor();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    UnsportingBehaviorMinor.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.UnsportingBehaviorMinor)
        return object;
      var message = new $root.GameEvent.UnsportingBehaviorMinor();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.UnsportingBehaviorMajor = (function () {
    ...
    UnsportingBehaviorMajor.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.UnsportingBehaviorMajor();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    UnsportingBehaviorMajor.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.UnsportingBehaviorMajor)
        return object;
      var message = new $root.GameEvent.UnsportingBehaviorMajor();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.KeeperHeldBall = (function () {
    ...
    KeeperHeldBall.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.KeeperHeldBall();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    KeeperHeldBall.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.KeeperHeldBall)
        return object;
      var message = new $root.GameEvent.KeeperHeldBall();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.PlacementSucceeded = (function () {
    ...
    PlacementSucceeded.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.PlacementSucceeded();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    PlacementSucceeded.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.PlacementSucceeded)
        return object;
      var message = new $root.GameEvent.PlacementSucceeded();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.Prepared = (function () {
    ...
    Prepared.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.Prepared();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    Prepared.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.Prepared)
        return object;
      var message = new $root.GameEvent.Prepared();
      if (object.timeTaken != null)
        message.timeTaken = Number(object.timeTaken);
      return message;
    };
  ...
  GameEvent.BotSubstitution = (function () {
    ...
    BotSubstitution.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length,
        message = new $root.GameEvent.BotSubstitution();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    BotSubstitution.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.BotSubstitution)
        return object;
      var message = new $root.GameEvent.BotSubstitution();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
  ...
  GameEvent.TooManyRobots = (function () {
    ...
    TooManyRobots.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.GameEvent.TooManyRobots();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    TooManyRobots.fromObject = function fromObject(object) {
      if (object instanceof $root.GameEvent.TooManyRobots)
        return object;
      var message = new $root.GameEvent.TooManyRobots();
      switch (object.byTeam) {
        case "UNKNOWN":
        case 0:
          message.byTeam = 0;
...
$root.Referee = (function () {
  ...
  Referee.encode = function encode(message, writer) {
    ...
    if (message.gameEvents != null && message.gameEvents.length)
      for (var i = 0; i < message.gameEvents.length; ++i)
    ...
    if (message.proposedGameEvents != null && message.proposedGameEvents.length)
      for (var i = 0; i < message.proposedGameEvents.length; ++i)
  ...
  Referee.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader))
      reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Referee();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  Referee.verify = function verify(message) {
    ...
    {
      var error = $root.Referee.TeamInfo.verify(message.yellow);
      if (error)
        return "yellow." + error;
    }
    {
      var error = $root.Referee.TeamInfo.verify(message.blue);
      if (error)
        return "blue." + error;
    }
    if (message.designatedPosition != null && message.hasOwnProperty("designatedPosition")) {
      var error = $root.Referee.Point.verify(message.designatedPosition);
      if (error)
    ...
    if (message.gameEvents != null && message.hasOwnProperty("gameEvents")) {
      ...
      for (var i = 0; i < message.gameEvents.length; ++i) {
        var error = $root.GameEvent.verify(message.gameEvents[i]);
        if (error)
    ...
    if (message.proposedGameEvents != null && message.hasOwnProperty("proposedGameEvents")) {
      ...
      for (var i = 0; i < message.proposedGameEvents.length; ++i) {
        var error = $root.ProposedGameEvent.verify(message.proposedGameEvents[i]);
        if (error)
  ...
  Referee.fromObject = function fromObject(object) {
    ...
    if (object.gameEvents) {
      ...
      message.gameEvents = [];
      for (var i = 0; i < object.gameEvents.length; ++i) {
    ...
    if (object.proposedGameEvents) {
      ...
      message.proposedGameEvents = [];
      for (var i = 0; i < object.proposedGameEvents.length; ++i) {
  ...
  Referee.toObject = function toObject(message, options) {
    ...
    if (message.gameEvents && message.gameEvents.length) {
      object.gameEvents = [];
      for (var j = 0; j < message.gameEvents.length; ++j)
        object.gameEvents[j] = $root.GameEvent.toObject(message.gameEvents[j], options);
    }
    if (message.proposedGameEvents && message.proposedGameEvents.length) {
      object.proposedGameEvents = [];
      for (var j = 0; j < message.proposedGameEvents.length; ++j)
  ...
  Referee.TeamInfo = (function () {
    ...
    TeamInfo.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Referee.TeamInfo();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    TeamInfo.fromObject = function fromObject(object) {
      if (object instanceof $root.Referee.TeamInfo)
        return object;
      var message = new $root.Referee.TeamInfo();
      if (object.name != null)
        message.name = String(object.name);
  ...
  Referee.Point = (function () {
    ...
    Point.decode = function decode(reader, length) {
      if (!(reader instanceof $Reader))
        reader = $Reader.create(reader);
      var end = length === undefined ? reader.len : reader.pos + length, message = new $root.Referee.Point();
      while (reader.pos < end) {
        var tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
    ...
    Point.fromObject = function fromObject(object) {
      if (object instanceof $root.Referee.Point)
        return object;
      var message = new $root.Referee.Point();
      if (object.x != null)
        message.x = Number(object.x);
      if (object.y != null)
        message.y = Number(object.y);
...
$root.ProposedGameEvent = (function () {
  ...
  ProposedGameEvent.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader))
      reader = $Reader.create(reader);
    var end = length === undefined ? reader.len : reader.pos + length, message = new $root.ProposedGameEvent();
    while (reader.pos < end) {
      var tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  ProposedGameEvent.verify = function verify(message) {
    ...
    {
      var error = $root.GameEvent.verify(message.gameEvent);
      if (error)
  ...
  ProposedGameEvent.fromObject = function fromObject(object) {
    if (object instanceof $root.ProposedGameEvent)
      return object;
    var message = new $root.ProposedGameEvent();
